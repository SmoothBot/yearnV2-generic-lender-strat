...
def test_withdraw_all_aave(strategyAddAAVE, token, chain, whale, vault, strategy, gov, strategist, lenders, amount, rando):
    run_withdraw_all_test(token, chain, whale, vault, strategy, gov, strategist, lenders, amount, rando)

...
def scrToken(interface):
    yield interface.CErc20I("0x4565DC3Ef685E4775cdF920129111DdF43B9d882")

@pytest.fixture
def crToken(interface):
    yield interface.CErc20I("0x20CA53E2395FA571798623F1cFBD11Fe2C114c24")
...
@pytest.fixture
def whale(accounts):
    yield accounts.at('0x38aCa5484B8603373Acc6961Ecd57a6a594510A3', True)
...
def strategy(
    ...
    print(scapr/1e8)
    print((screamPlugin.apr() - scapr)/1e8)

    scapr2 = screamPlugin.compBlockShareInWant(140 * 1e8, True) * 3154 * 10**4
    print(scapr2/1e8)
    assert scapr2 < scapr

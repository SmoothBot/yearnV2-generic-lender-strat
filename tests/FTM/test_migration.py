...
@pytest.mark.parametrize(config.fixtures, config.params, indirect=True)
def test_good_migration_scream(
    token, strategy, strategyAddScream, vault, gov, strategist, guardian, whale, amount, TestStrategy, rando, chain
):
    run_good_migration_test(token, strategy, vault, gov, strategist, guardian, whale, amount, TestStrategy, rando, chain)
...
@pytest.mark.parametrize(config.fixtures, config.params, indirect=True)
def test_good_migration_lqdr_hnd(
    token, strategy, strategyAddLqdrHND, vault, gov, strategist, guardian, whale, amount, TestStrategy, rando, chain
):
    run_good_migration_test(token, strategy, vault, gov, strategist, guardian, whale, amount, TestStrategy, rando, chain)
